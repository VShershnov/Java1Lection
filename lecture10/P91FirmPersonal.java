...
public class P91FirmPersonal {
	
	public P91FirmPersonal(String fio, int age) {
	...
	public P91FirmPersonal(String fio, String department, String position){
		this.fio = fio;
	...
	public P91FirmPersonal(String fio, int age, int salesVolume){
		this.fio = fio;
